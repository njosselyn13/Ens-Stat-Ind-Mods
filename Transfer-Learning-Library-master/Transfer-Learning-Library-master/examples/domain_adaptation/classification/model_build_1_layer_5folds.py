...
input_dimension = desired_feat_size*5 # either 5 DA models OR 5 folds
...
file_save = '5folds_' + 'Gaussian_' + str(gaussian_projecting) + '_Feat_' + str(feat_extract_exps) + '_SOFTMAX_' + str(sftmx) + '_stacked_linear_1layer_lr' + lr_str + '_epochs' + str(num_epochs)
...
for adapt_task in adapt_tasks:
    ...
    if feat_extract_exps == True:
        ...
        all_models_concat = np_hstack # np.hstack(
