...
targets = ['c', 'i', 'p', 'q', 'r', 's'] # the 6 possible target domains in this case for multi-source code

adapt_tasks = {'c': ['DomainNet_i2c', 'DomainNet_p2c', 'DomainNet_q2c', 'DomainNet_r2c', 'DomainNet_s2c'],
                 'i': ['DomainNet_c2i', 'DomainNet_p2i', 'DomainNet_q2i', 'DomainNet_r2i', 'DomainNet_s2i'],
                 'p': ['DomainNet_c2p', 'DomainNet_i2p', 'DomainNet_q2p', 'DomainNet_r2p', 'DomainNet_s2p'],
                 'q': ['DomainNet_c2q', 'DomainNet_i2q', 'DomainNet_p2q', 'DomainNet_r2q', 'DomainNet_s2q'],
                 'r': ['DomainNet_c2r', 'DomainNet_i2r', 'DomainNet_p2r', 'DomainNet_q2r', 'DomainNet_s2r'],
                 's': ['DomainNet_c2s', 'DomainNet_i2s', 'DomainNet_p2s', 'DomainNet_q2s', 'DomainNet_r2s']}
...
# saving files
df_pseudo.to_csv(parent_dir + 'domainnet_multi_pseudo_labels_using_conf_score_' + train_or_test + '.csv')
df_gt.to_csv(parent_dir + 'domainnet_multi_gt_labels_' + train_or_test + '.csv')

df_pseudo_mode.to_csv(parent_dir + 'domainnet_multi_pseudo_labels_using_mode_' + train_or_test + '.csv')
