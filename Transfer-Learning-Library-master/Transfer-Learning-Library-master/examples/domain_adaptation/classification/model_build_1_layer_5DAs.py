...
file_save = '5DAs_' + 'Gaussian_' + str(gaussian_projecting) + '_Feat_' + str(feat_extract_exps) + '_SOFTMAX_' + str(sftmx) + '_stacked_linear_1layer_lr' + lr_str + '_epochs' + str(num_epochs)
...
for adapt_task in adapt_tasks:
    ...
    if feat_extract_exps == True:
        ...
        for m in models:
            ...
            np_hstack = npy_load1 #np.hstack((npy_load1, npy_load2, npy_load3, npy_load4, npy_load5))
