...
def main(args: argparse.Namespace):
    ...
    if args.phase == 'analysis':
        ...
        # plot t-SNE
        tSNE_filename = osp.join(logger.visualize_directory, 'TSNE_test_save_all_1_gpu.png')
    ...
    if args.phase == 'test':
        ...
        #classifier.load_state_dict(torch.load(logger.get_checkpoint_path('latest'))) # use best for DomainNet, 'latest' for ARL data
        ...
        np.save('feature_lists/dataset/' + 'DANN/' + str(args.source) + '_' + str(args.target) + '_' + str(args.log[-1]) + '_feature_list.npy', feat_list)
        ...
        #test_gt_pred.to_csv(args.log + "/" + 'off31_test_set_gt_pred_ratings_2_latestmod.csv')
